...
def bdf_from_bmf(input_bmf_path, output_bdf_path):
    '''
...
def bmf_to_csv(input_bmf_path, output_csv_path, bounding_triangulation=None, mask_variable=[None, None], test_condition=None):
    '''
...
def bmf_to_pandas(input_bmf_path, remove_header_rows=True, bounding_triangulation=None, mask_variable=[None, None], test_condition=None):
    '''
...
def set_variable(input_bmf_path, variable, value):
    '''
...
def create_variable(input_bmf_path, variable, value):
    '''
